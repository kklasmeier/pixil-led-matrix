...
PARAMETER_TYPES: Dict[str, CommandParams] = {
    ...
    'ink_step': [],
    'particle_flock': [
        {'name': 'x', 'type': 'str', 'position': 0},
        {'name': 'y', 'type': 'str', 'position': 1},
        {'name': 'vx', 'type': 'str', 'position': 2},
        {'name': 'vy', 'type': 'str', 'position': 3},
        {'name': 'ax', 'type': 'str', 'position': 4},
        {'name': 'ay', 'type': 'str', 'position': 5},
        {'name': 'active', 'type': 'str', 'position': 6},
        {'name': 'separation_distance', 'type': 'float', 'position': 7},
        {'name': 'neighbor_distance', 'type': 'float', 'position': 8},
        {'name': 'separation_weight', 'type': 'float', 'position': 9, 'optional': True},
        {'name': 'alignment_weight', 'type': 'float', 'position': 10, 'optional': True},
        {'name': 'cohesion_weight', 'type': 'float', 'position': 11, 'optional': True},
        {'name': 'max_speed', 'type': 'float', 'position': 12, 'optional': True},
        {'name': 'max_force', 'type': 'float', 'position': 13, 'optional': True},
        {'name': 'wrap_width', 'type': 'float', 'position': 14, 'optional': True},
        {'name': 'wrap_height', 'type': 'float', 'position': 15, 'optional': True},
        {'name': 'count', 'type': 'int', 'position': 16, 'optional': True},
    ],
    'particle_verlet_integrate': [
        {'name': 'x', 'type': 'str', 'position': 0},
        {'name': 'y', 'type': 'str', 'position': 1},
        {'name': 'old_x', 'type': 'str', 'position': 2},
        {'name': 'old_y', 'type': 'str', 'position': 3},
        {'name': 'active', 'type': 'str', 'position': 4},
        {'name': 'ax', 'type': 'str', 'position': 5, 'optional': True},
        {'name': 'ay', 'type': 'str', 'position': 6, 'optional': True},
        {'name': 'damping', 'type': 'float', 'position': 7, 'optional': True},
        {'name': 'count', 'type': 'int', 'position': 8, 'optional': True},
    ],
    'particle_constrain_distances': [
        {'name': 'x', 'type': 'str', 'position': 0},
        {'name': 'y', 'type': 'str', 'position': 1},
        {'name': 'active', 'type': 'str', 'position': 2},
        {'name': 'link_from', 'type': 'str', 'position': 3},
        {'name': 'link_to', 'type': 'str', 'position': 4},
        {'name': 'rest_length', 'type': 'str', 'position': 5},
        {'name': 'stiffness', 'type': 'str', 'position': 6, 'optional': True},
        {'name': 'iterations', 'type': 'int', 'position': 7, 'optional': True},
        {'name': 'tension', 'type': 'str', 'position': 8, 'optional': True},
        {'name': 'count', 'type': 'int', 'position': 9, 'optional': True},
        {'name': 'link_count', 'type': 'int', 'position': 10, 'optional': True},
        {'name': 'min_distance', 'type': 'float', 'position': 11, 'optional': True},
    ],
    'particle_apply_springs': [
        {'name': 'x', 'type': 'str', 'position': 0},
        {'name': 'y', 'type': 'str', 'position': 1},
        {'name': 'force_x', 'type': 'str', 'position': 2},
        {'name': 'force_y', 'type': 'str', 'position': 3},
        {'name': 'active', 'type': 'str', 'position': 4},
        {'name': 'link_from', 'type': 'str', 'position': 5},
        {'name': 'link_to', 'type': 'str', 'position': 6},
        {'name': 'rest_length', 'type': 'str', 'position': 7},
        {'name': 'stiffness', 'type': 'str', 'position': 8, 'optional': True},
        {'name': 'tension', 'type': 'str', 'position': 9, 'optional': True},
        {'name': 'count', 'type': 'int', 'position': 10, 'optional': True},
        {'name': 'link_count', 'type': 'int', 'position': 11, 'optional': True},
    ],
    'particle_apply_attractors': [
        {'name': 'x', 'type': 'str', 'position': 0},
        {'name': 'y', 'type': 'str', 'position': 1},
        {'name': 'ax', 'type': 'str', 'position': 2},
        {'name': 'ay', 'type': 'str', 'position': 3},
        {'name': 'active', 'type': 'str', 'position': 4},
        {'name': 'attractor_x', 'type': 'str', 'position': 5},
        {'name': 'attractor_y', 'type': 'str', 'position': 6},
        {'name': 'attractor_strength', 'type': 'str', 'position': 7, 'optional': True},
        {'name': 'particle_strength', 'type': 'str', 'position': 8, 'optional': True},
        {'name': 'falloff', 'type': 'float', 'position': 9, 'optional': True},
        {'name': 'softening', 'type': 'float', 'position': 10, 'optional': True},
        {'name': 'max_acceleration', 'type': 'str', 'position': 11, 'optional': True},
        {'name': 'count', 'type': 'int', 'position': 12, 'optional': True},
        {'name': 'attractor_count', 'type': 'int', 'position': 13, 'optional': True},
        {'name': 'swirl', 'type': 'float', 'position': 14, 'optional': True},
    ],
    'particle_integrate': [
        {'name': 'x', 'type': 'str', 'position': 0},
        {'name': 'y', 'type': 'str', 'position': 1},
        ...
        {'name': 'ay', 'type': 'str', 'position': 6, 'optional': True},
        {'name': 'damping', 'type': 'float', 'position': 7, 'optional': True},
        {'name': 'sleep_speed', 'type': 'float', 'position': 8, 'optional': True},
        {'name': 'count', 'type': 'int', 'position': 9, 'optional': True},
        {'name': 'integration_mode', 'type': 'str', 'position': 10, 'optional': True},
        {'name': 'max_speed', 'type': 'str', 'position': 11, 'optional': True},
        {'name': 'position_scale', 'type': 'float', 'position': 12, 'optional': True},
    ],
    'particle_collide_bounds': [
        ...
        {'name': 'vy', 'type': 'str', 'position': 3},
        {'name': 'active', 'type': 'str', 'position': 4},
        {'name': 'left', 'type': 'float', 'position': 5},
        {'name': 'right', 'type': 'float', 'position': 6},
        {'name': 'top', 'type': 'float', 'position': 7},
        {'name': 'bottom', 'type': 'float', 'position': 8},
        {'name': 'restitution', 'type': 'str', 'position': 9, 'optional': True},
        {'name': 'radius', 'type': 'str', 'position': 10, 'optional': True},
        {'name': 'hit', 'type': 'str', 'position': 11, 'optional': True},
        {'name': 'count', 'type': 'int', 'position': 12, 'optional': True},
    ],
    'particle_collide_circle_bounds': [
        ...
        {'name': 'vy', 'type': 'str', 'position': 3},
        {'name': 'active', 'type': 'str', 'position': 4},
        {'name': 'center_x', 'type': 'float', 'position': 5},
        {'name': 'center_y', 'type': 'float', 'position': 6},
        {'name': 'boundary_radius', 'type': 'float', 'position': 7},
        {'name': 'restitution', 'type': 'str', 'position': 8, 'optional': True},
        {'name': 'radius', 'type': 'str', 'position': 9, 'optional': True},
        {'name': 'angular_speed', 'type': 'float', 'position': 10, 'optional': True},
        {'name': 'grip', 'type': 'float', 'position': 11, 'optional': True},
        {'name': 'hit', 'type': 'str', 'position': 12, 'optional': True},
        {'name': 'count', 'type': 'int', 'position': 13, 'optional': True},
    ],
    'particle_collide_circles': [
        ...
        {'name': 'vy', 'type': 'str', 'position': 3},
        {'name': 'active', 'type': 'str', 'position': 4},
        {'name': 'radius', 'type': 'str', 'position': 5},
        {'name': 'mass', 'type': 'str', 'position': 6, 'optional': True},
        {'name': 'restitution', 'type': 'str', 'position': 7, 'optional': True},
        {'name': 'hit', 'type': 'str', 'position': 8, 'optional': True},
        {'name': 'count', 'type': 'int', 'position': 9, 'optional': True},
    ],
    'particle_collide_static_circles': [
        ...
        {'name': 'vy', 'type': 'str', 'position': 3},
        {'name': 'active', 'type': 'str', 'position': 4},
        {'name': 'obstacle_x', 'type': 'str', 'position': 5},
        {'name': 'obstacle_y', 'type': 'str', 'position': 6},
        {'name': 'radius', 'type': 'str', 'position': 7},
        {'name': 'obstacle_radius', 'type': 'str', 'position': 8},
        {'name': 'restitution', 'type': 'str', 'position': 9, 'optional': True},
        {'name': 'hit', 'type': 'str', 'position': 10, 'optional': True},
        {'name': 'count', 'type': 'int', 'position': 11, 'optional': True},
        {'name': 'obstacle_count', 'type': 'int', 'position': 12, 'optional': True},
        {'name': 'response', 'type': 'str', 'position': 13, 'optional': True},
    ],
}
